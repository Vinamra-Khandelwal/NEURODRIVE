...
const traffic=[
    ...
    new Car(road.getLaneCenter(1),-1250,30,50,"DUMMY",2,getRandomColor()),
    ...
    new Car(road.getLaneCenter(0),-1850,30,50,"DUMMY",2,getRandomColor()),
    ...
    new Car(road.getLaneCenter(1),-2350,30,50,"DUMMY",2,getRandomColor()),
    new Car(road.getLaneCenter(1),-2440,30,50,"DUMMY",2,getRandomColor()),
    new Car(road.getLaneCenter(0),-2500,30,50,"DUMMY",2,getRandomColor()),
    new Car(road.getLaneCenter(1),-2650,30,50,"DUMMY",2,getRandomColor()),
    //new Car(road.getLaneCenter(0),-2700,30,50,"DUMMY",2,getRandomColor()),
    new Car(road.getLaneCenter(2),-2860,30,50,"DUMMY",2,getRandomColor()),
    new Car(road.getLaneCenter(2),-2950,30,50,"DUMMY",2,getRandomColor()),
    new Car(road.getLaneCenter(2),-3000,30,50,"DUMMY",2,getRandomColor()),
    new Car(road.getLaneCenter(0),-3110,30,50,"DUMMY",2,getRandomColor()),
    ...
    new Car(road.getLaneCenter(0),-3610,30,50,"DUMMY",2,getRandomColor()),
    new Car(road.getLaneCenter(2),-3750,30,50,"DUMMY",2,getRandomColor()),
    new Car(road.getLaneCenter(0),-3800,30,50,"DUMMY",2,getRandomColor()),
    new Car(road.getLaneCenter(2),-3950,30,50,"DUMMY",2,getRandomColor()),
